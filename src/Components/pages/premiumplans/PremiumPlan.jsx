...
const PremiumPlan = () => {
  ...
  useEffect(() => {
    ...
    gsap.fromTo(
      text,
      { y: 100, duration: 2, opacity: 0, ease: "back" },
      {
        y: 0,
        opacity: 1,
        duration: 2,
    ...
    <Wrapper>
      <MDBContainer fluid className="py-5">
        <section style={{ color: "whitesmoke" }} className="text-start">
          <MDBTypography tag="h1" style={{ fontSize: "min(12vw,4rem)" }}>
            Premium home workouts <br />
            and fitness plans
          </MDBTypography>
          <MDBTypography style={{ letterSpacing: "2px" }}>
            I’ve created these premium fitness classes for everyone starting
            <br /> from beginner to advanced level with an in depth FAQ.
          </MDBTypography>
          <MDBBtn
            className="py-4 px-3"
            style={{ letterSpacing: "4px", width: "250px" }}
          >
            <MDBIcon icon="angle-right" fas /> VIEW ALL
          </MDBBtn>
        </section>
      ...
      >
        <MDBTypography
          ...
          style={{ fontFamily: "cursive", color: "whitesmoke" }}
          ref={textref}
        >
          Sweat. Gain. Do.
        </MDBTypography>
