    ...
    <Wrapper>
       <MDBContainer fluid>
        <MDBRow className='g-4 py-5 background'>
            {/* image */}
            <MDBCol size='12' md='6'>
<MDBCardImage src={hometraning1} alt='hometraning1' className='rounded' fluid style={{maxHeight:"600px",width:'100%'}}/>
            </MDBCol>
            {/* content */}
            <MDBCol size='12' md='6' className='text-start d-flex flex-column justify-content-center'>
            <span>30 MINUTES</span>
            <MDBTypography tag='h1' style={{fontSize:"min(4rem,12vw)"}} className='fw-bolder'>The Perfect Outdoor Workout</MDBTypography>
