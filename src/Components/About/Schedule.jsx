...
import image1 from '../../Images/hometraining1.jpeg'
    ...
    <Wrapper className='my-5'>
       ...
       <MDBRow className=''>
        <MDBCol  size='12' md='6' className='text-start'>
         <MDBTypography tag='h1' className='fw-bolder'>I am Sai</MDBTypography>
        ...
        <MDBBtn className='button'><MDBIcon icon='angle-right' fas/> Schedule Call</MDBBtn>
        ...
        <MDBCol size='12' md='6' className='d-flex justify-content-center'>
           <div className='box '>
            <figure ref={imageref}>
               <MDBCardImage className='img rounded-5' src={image1} alt='schedule' fluid/>
               </figure>
           </div>
