      ...
      <MDBContainer fluid>
        <MDBRow className="">
          <MDBCol size="12" md="6" className="text-start">
            ...
            <p className="fw-bold">
              <strong>01</strong>&nbsp;&nbsp; Over 10 years of experience
            </p>
            <p className="fw-bold">
              <strong>02</strong>&nbsp;&nbsp; Coached 2,000+ people
            </p>
            <p className="fw-bold">
              <strong>03</strong>&nbsp;&nbsp; Bachelors in nutrition
            </p>
          ...
          <MDBCol size="12" md="6" className="d-flex justify-content-center mt-5">
            <div className="box ">
              <figure ref={imageref}>
                <MDBCardImage
