        ...
        <MDBContainer  fluid>
            <MDBRow className='py-5 align-items-center'>
                <MDBCol size='12' md='6' className='text-start mb-5'>
                 ...
                 <MDBTypography tag='h1' className='fw-bolder mb-3' style={{fontSize:"3rem"}}>Who can benefit from a fully custom online fitness plan & nutrition?</MDBTypography>
                 <MDBTypography className='mb-3'>Literally everyone. I’m currently helping people from 12 to 60+ years old. Everyone is getting an adjusted program and a meal plan.</MDBTypography>
